...
{availableSoirees.length > 0 && !proposeSent && (
        ...
        {alreadyProposed && !proposeSent && availableSoirees.length === 0 && <span className="flex-1 text-xs py-2.5 rounded-lg bg-dim/10 text-dim border border-border text-center">Demande déjà envoyée</span>}
      </div>
